...
public class ExprSetSpellSeedOwner extends SimpleExpression<SpellSeed> {

    static {
        Skript.registerExpression(ExprSetSpellSeedOwner.class, SpellSeed.class, ExpressionType.COMBINED, "%spell% ownered by %entity%");
    }
    ...
    protected SpellSeed[] get(Event event) {
        ...
        seed[0].setOwner(entityExpression.getSingle(event));
